...
export default function Hero() {
  return (
    <main className="p-4 lg:px-8 select-none">
      <h1 className="text-5xl font-bold text-white mt-12 leading-relaxed">
      ...
      <button className="bg-white text-zinc-950 py-3 px-6 rounded-lg my-16 cursor-pointer flex gap-6 items-center">
        Talk to use
